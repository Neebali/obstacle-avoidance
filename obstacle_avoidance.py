...
class liVFH:
    def __init__(self, robot_radius: int, safty_distance: int, turn_radius: int, measurement_threshold: int, wide_opening_deg = 10) -> None:

        """The liVFH is based on the VHF+ Algorithm but has been modified to work with 360 degrees lidars
        Parameters:
        robot_radius (int): The radius of the robot
        safty_distance (int): The distance the robot will keep from any given obsticle
        turn_radius (int): The the minimum turnradius the robot will go to either left or right
        mesurment_threshold (int): The cutoff point of how far the robot will look for obsticles
        wide_opening_deg (int): How many degrees an opening has to be, from the robots perspective, for it to be considered a wide opening      
        """

        self.robot_radius = robot_radius
        self.safty_distance = safty_distance
        self.turn_radius = turn_radius
        self.threshold = measurement_threshold
        self.mu1 = 5
        self.mu2 = 2
        self.mu3 = 2
        self.robot_radius_safty_distance = self.robot_radius + self.safty_distance
